...
dbLoadRecords("$(DB_TOP)/genesysGEN5kWPS.db", "P=$(PREFIX),PORT=PORT$(MOXA_PORT),ADDR=$(ADDR),OVPMIN=$(_OVPMIN),OVPMAX=$(_OVPMAX),UVLMIN=$(_UVLMIN),UVLMAX=$(_UVLMAX),VMIN=$(_VMIN),VMAX=$(_VMAX),CMIN=$(_CMIN),CMAX=$(_CMAX)")
